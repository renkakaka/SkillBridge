        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Link href="/auth/signin">
              <Button variant="ghost" size="lg" className="text-neutral-700 hover:text-primary-600 hover:bg-primary-50 transition-all duration-200 px-4 py-2">
                {t('navigation.signIn')}
              </Button>
            </Link>
            <Link href="/auth/signup">
              <Button size="lg" className="bg-gradient-primary hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 px-5 py-2">
                {t('navigation.signUp')}
              </Button>
            </Link>
          </div>
          ...
          <div className="lg:hidden border-t border-neutral-200/50 py-4 bg-white/95 backdrop-blur-md">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="pt-4 border-t border-neutral-200/50 space-y-2">
                <Link href="/auth/signin">
                  <Button variant="ghost" className="w-full justify-start text-neutral-700 hover:text-primary-600 hover:bg-primary-50 text-base py-3">
                    {t('navigation.signIn')}
                  </Button>
                </Link>
                <Link href="/auth/signup">
                  <Button className="w-full bg-gradient-primary hover:shadow-lg text-base py-3">
                    {t('navigation.signUp')}
                  </Button>
                </Link>
              </div>
